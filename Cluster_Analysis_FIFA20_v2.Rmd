...
<h2> Hierarchical Clustering vs K-Means Clustering </h2>
...
Reference: [**SteupAnalytics.com**](https://stepupanalytics.com/difference-between-k-means-clustering-and-hierarchical-clustering/)

<h2> Comparing kmeans() and hclust() </h2>

<h3> Goalkeepers </h3>

```{r Comparing kmeans and hclust goalkeepers, }

# Apply cutree() to gk.hclust : gk.cut
gk.cut <- cutree(gk.hclust , k = 4)
...
```{r Comparing kmeans and hclust outfield players, }
...
<h2> Implication of the Analysis </h2>
