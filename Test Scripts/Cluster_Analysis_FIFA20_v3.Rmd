...
```{r Plotting the GK cluster, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', fig.height=10,fig.width=10 }
library(fpc)
...
```{r Plotting the Outflied cluster, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', fig.height=10,fig.width=10 }
library(fpc)
...
<h3> <b> Checking the Prediction Strength - Outfiled Players </b> </h3>
...
<h3> Views the items in the selected cluster - Goalkeeprs </h3>

```{r Items in the selected cluster GK,echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', fig.height=10,fig.width=10  }
...
```{r Plotting the hclust() for Goalkeepers  k 3, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', fig.height=10,fig.width=10  }
...
<h2> Hierarchical Clustering Analysis for Outfileld Players</h2>
...
rect.hclust(hclust(outfield.dist, method = "ward"), h = 5500)
...
```{r Items in the selected cluster Outfield players, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', fig.height=10,fig.width=10  }
...
```{r Plotting the hclust() for Outfield Players k 3, echo=TRUE, message=FALSE, warning=FALSE, fig.align='center', fig.height=10, fig.width=10  }
#get cluster means for raw data
#Centroid Plot against 1st 2 discriminant functions
#Load the fpc library needed for plotcluster function
library(fpc)
